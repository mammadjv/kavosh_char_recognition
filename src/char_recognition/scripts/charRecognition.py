...
class CharRecognition:
	def __init__(self):
		...
		self.pattern_perceptor = PatternPerceptor('/home/ubuntu/Kavosh_Char_Recognition/src/char_recognition/scripts/deploy.prototxt','/home/ubuntu/Kavosh_Char_Recognition/src/char_recognition/scripts/hand_written.caffemodel')
